...
Selectors confirmed 2026-04-27 via Playwright codegen against
...
class LoginPage:
    ...
    def fill_email(self, email: str) -> None:
        ...
        # confirmed 2026-04-27 — advances to the password screen
    ...
    def fill_totp(self, code: str) -> None:
        ...
        # confirmed 2026-04-27 — choose TOTP factor before entering digits
